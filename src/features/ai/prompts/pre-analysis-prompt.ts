...
export function buildPreAnalysisUserPrompt(context: string) {
  return [
    ...
    "41. Em mapa_documental_autor, trate cada item como unidade rastreavel: nome do arquivo ou identificador, tipo, titular ou emitente, vinculo subjetivo, achado principal, impacto para defesa e ponto de atencao.",
    "42. Em analise_narrativa_vs_documentos, justifique de forma central e coerente se os documentos embasam a narrativa e os pedidos, evitando contradicoes com matriz_final_confronto e suficiencia_probatoria.",
    "43. Em cadeia_negocial, identifique objetivamente comprador, pagador, beneficiario, reclamante e destinatario de estorno quando isso for verificavel; se nao for, registre a lacuna de forma prudente.",
    "44. Em coerencia_entre_documentos, diferencie com clareza divergencias de nomes, datas, valores, localizadores, codigos de voo e identificadores operacionais.",
    "45. Em analise_por_tipo_documental, se houver procuracao, identidade, comprovante de endereco, reserva, comprovante de pagamento, declaracao ou print, reflita isso explicitamente no bloco correspondente.",
    "46. Em fatos_supervenientes_ou_da_emenda, registre fatos novos, pedidos novos, agravantes novos ou documentos supervenientes que merecam enfrentamento especifico.",
    "47. Em pontos_exploraveis_defesa, privilegie pontos concretos e auditaveis, como inconsistencia temporal, divergencia operacional, fragilidade de lastro documental, lacuna de quantificacao e divergencia subjetiva.",
